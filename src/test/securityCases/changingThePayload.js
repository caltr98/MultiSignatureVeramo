...
async function ChangePayloadSignatureVCAggregateKeysToSignatures(issuers, holder, claimCount, valueSize, seed = 42) {
...
export { ChangePayloadSignatureVCAggregateKeysToSignatures };
