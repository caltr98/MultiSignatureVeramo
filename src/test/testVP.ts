...
import {
    ...
    HolderInfo,
    benchmarkStep,
} from './holder_test.js' // was './holder_test.js'
import {
    PoOMultiHolderVP,
...
async function main() {
    ...
    await benchmarkStep(`Create VP (holders=${HOLDERS_N}, PoO=${USE_POO})`, timings, async () => {
        ...
        vp = (await createMultiHolderPresentation(holders, USE_POO, timings,undefined,undefined,{ciao:"ciao"})) as PoOMultiHolderVP
