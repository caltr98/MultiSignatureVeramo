 ...
 */
async function createAgent(name: string): Promise<{ did: string; kid_bls: string; bls_pub_key: string }> {
 ...
 */
export async function setup_bls_agents(numberOfAgents: number = 3): Promise<AgentInfo[]> {
