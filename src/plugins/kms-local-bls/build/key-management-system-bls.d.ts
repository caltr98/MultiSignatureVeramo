 ...
 * @public
 */
export declare class BlsKeyManagementSystem extends AbstractKeyManagementSystem {
    private readonly keyStore;
    private readonly blsBackend;
    private chainsafeBlsPromise?;
    private nobleBlsPromise?;
    constructor(keyStore: AbstractPrivateKeyStore, options?: {
    ...
    private signBls;
    private aggregateBls;
    private deriveBlsPublicKeyHex;
    private getChainsafeBls;
    private getNobleBls;
}
export {};
