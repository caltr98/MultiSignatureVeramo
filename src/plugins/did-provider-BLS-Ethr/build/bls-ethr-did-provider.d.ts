import { IAgentContext, IIdentifier, IKey, IKeyManager, IKeyManagerCreateArgs, IService, MinimalImportableKey, TKeyType } from '@veramo/core-types';
import { AbstractIdentifierProvider } from '@veramo/did-manager';
import { Provider, TransactionRequest } from 'ethers';
export type ImportOrCreateKeyOptions<TKey extends TKeyType = TKeyType> = Omit<IKeyManagerCreateArgs & MinimalImportableKey, 'kms' | 'type'> & {
    type: TKey;
};
 ...
 * @public
 */
export declare class BlsEthrDIDProvider extends AbstractIdentifierProvider {
    private defaultKms;
    private networks;
    private gas?;
    private ttl?;
