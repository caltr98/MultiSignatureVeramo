 ...
 * @public
 */
export declare class DIDManagerBls implements IAgentPlugin {
    /**
     * Plugin methods
     * @public
     */
    ...
    didManagerAddKey({ did, key, options, NoPublish }: IDIDBlsManagerAddKeyArgs, context: IAgentContext<IKeyManager>): Promise<any>;
